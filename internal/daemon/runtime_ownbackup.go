...
// RuntimeOwnBackupSnapshot is the own-backup totals in the runtime snapshot.
...
// ownBackupFromIndex returns a closure that lists the index and aggregates totals.
